...
class CMT(nn.Module):
    def __init__(self, img_size=64, in_chans=1, num_classes=96, embed_dims=[46,92,128], stem_channel=16, fc_dim=256,
                 num_heads=[1,2,4], mlp_ratios=[3.6,3.6,3.6], qkv_bias=True, qk_scale=None, representation_size=None,
                 drop_rate=0., attn_drop_rate=0., drop_path_rate=0., hybrid_backbone=None, norm_layer=None,
                 depths=[2,4,2], qk_ratio=1, sr_ratios=[8,4,1], dp=0.1):
        super().__init__()
